...
export abstract class UserRepository {
  abstract create(data: { email: string; password: string; name?: string }): Promise<UserEntity>;
  ...
  abstract setEmailVerificationToken(userId: string, token: string, expiresAt: Date): Promise<void>;
